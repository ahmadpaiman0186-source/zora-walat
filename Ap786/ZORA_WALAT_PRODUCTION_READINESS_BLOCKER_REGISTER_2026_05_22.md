...
| **CORE10-BLK-OBS-GAPS-001** | **OPEN** | _SRE + ops_ — [L-48](./ZORA_WALAT_L48_OPERATOR_EVIDENCE_PRESTAGE_READINESS_GATE_2026_06_03.md): dropzone ready; **0** capture artifacts; full observability **NOT FULLY_PROVEN** |
...
| **CORE10-BLK-L46-OPERATOR-READONLY-EVIDENCE-001** | **PENDING OPERATOR CAPTURE** | _Operator + SRE_ — [L-48](./ZORA_WALAT_L48_OPERATOR_EVIDENCE_PRESTAGE_READINESS_GATE_2026_06_03.md): dropzone created; operator must stage redacted files; **NO-GO** |
| **CORE10-BLK-L47-EVIDENCE-INTAKE-001** | **BLOCKED_NO_OPERATOR_EVIDENCE** | _Program + operator_ — [L-47](./ZORA_WALAT_L47_OPERATOR_READONLY_OBSERVABILITY_EVIDENCE_INTAKE_2026_06_02.md) intake blocked until evidence staged in dropzone; **NOT FULLY_PROVEN**; **NO-GO** |
| **CORE10-BLK-L48-PRESTAGE-001** | **FILED / DROPZONE READY / NO EVIDENCE CAPTURED** | _Program + operator_ — [L-48](./ZORA_WALAT_L48_OPERATOR_EVIDENCE_PRESTAGE_READINESS_GATE_2026_06_03.md) local dropzone + manifest filed; **0** capture artifacts; **NO-GO** |
| **CORE10-BLK-L49-CAPTURE-APPROVAL-001** | **FILED / APPROVAL REQUIRED / NO CAPTURE EXECUTED** | _Program + operator_ — [L-49](./ZORA_WALAT_L49_OPERATOR_READONLY_EVIDENCE_CAPTURE_APPROVAL_GATE_2026_06_03.md) L-50 phrase filed; capture **not authorized** until phrase issued; **NO-GO** |
