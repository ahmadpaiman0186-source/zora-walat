...
| **CORE10-BLK-OBS-GAPS-001** | **OPEN** | _SRE + ops_ — Open gaps after L-38: no verified alert routing; no uptime/synthetics; no incident/on-call; no money-path observability; no restore/rollback drill proof; no `OBS-SIGN-SRE-001` |
