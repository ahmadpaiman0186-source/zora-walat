...
| **AFGCARD00-DOMESTIC-WALLET-CARD-001** | **BLOCKED / ARCHITECTURE FILED ONLY** | _Program + legal + compliance + banking_ — Afghanistan domestic wallet/card/ATM/POS/bill-pay/top-up architecture documented; **domestic-only — excludes cross-border remittance**; no bank contract, switch/APS/AfPay approval, biller contract, telecom contract, legal/compliance approval, runtime implementation, card issuance, DB schema, migration, wallet/card mutation, bill payment, mobile top-up, ATM/POS transaction, pilot, or production evidence; [architecture](./ZORA_WALAT_AFG_CARD00_DOMESTIC_DIGITAL_WALLET_CARD_ARCHITECTURE_2026_05_28.md) |
