...
| **CORE10-STAGING-DOCTOR-OBS-001** | **PARTIAL / SNAPSHOT MINIMUM** | _Engineering + SRE + ops_ — [L-30](./ZORA_WALAT_L30_SAME_WINDOW_REDEPLOY_TOKEN_REFRESH_READONLY_SNAPSHOT_EVIDENCE_2026_05_31.md): surface PASS (no redeploy); **TOKEN_VALID**; operator read-only snapshot **COMPLETED**; full DB/webhook export **NOT PROVEN**; doctor/obs **NOT VERIFIED**; production/pilot/real-money/market **NO-GO** |
