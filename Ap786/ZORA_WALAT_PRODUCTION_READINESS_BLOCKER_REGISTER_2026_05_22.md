...
| **CORE10-STAGING-DOCTOR-OBS-001** | **BLOCKED / L-25 SURFACE PASS — TOKEN + SNAPSHOT PENDING** | _Engineering + SRE + ops_ — [L-25 redeploy](./ZORA_WALAT_L25_STAGING_API_SURFACE_CORRECTION_REDEPLOY_EVIDENCE_2026_05_31.md): health/smoke **PASS** `dpl_HFmf5zNdyxeW4W5EmduFfHVBTAyX`; L-22 `login` **500** **not** re-tested; operator token **expired**; snapshot **NOT EXECUTED**; **CORE10-BLK-CAPTURE-001** **OPEN**; doctor/obs **NOT VERIFIED**; production/pilot/real-money/market **NO-GO** |
