...
| **G-02-WH-STG** | **FAILED / INCONCLUSIVE** | _Payments + engineering_ — STR-02 **404**; Vercel Root Directory=**`./`** captured (**H2 strengthened**); D03–D07 **PENDING**; root cause **NOT CONFIRMED** |
