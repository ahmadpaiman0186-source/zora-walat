...
| **CORE10-STAGING-DOCTOR-OBS-001** | **BLOCKED / L-11 TOKEN GATE FILED** | _Engineering + SRE + ops_ — L-10 API surface **CORRECTED** (PR #125); [L-11 token refresh retry approval gate](./ZORA_WALAT_L11_CORE10_TOKEN_REFRESH_RETRY_APPROVAL_GATE_2026_05_30.md) — **not** login/token in L-11; future L-12 phrase `APPROVE L-12 READ-ONLY STAGING OPERATOR TOKEN REFRESH RETRY WITH GITIGNORED LOCAL CREDS ONLY`; **CORE10-BLK-CAPTURE-001** **OPEN**; token refresh retry **NOT EXECUTED**; full snapshot **NOT EXECUTED**; doctor/obs **NOT VERIFIED**; production/pilot/real-money/market **NO-GO** |
