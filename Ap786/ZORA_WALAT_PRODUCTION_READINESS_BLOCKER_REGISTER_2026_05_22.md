...
| **CORE10-STAGING-DOCTOR-OBS-001** | **BLOCKED / L-19 TOKEN OK — SNAPSHOT OPEN** | _Engineering + SRE + ops_ — [L-19 evidence](./ZORA_WALAT_L19_CORE10_TOKEN_REFRESH_AFTER_API_SURFACE_PASS_EVIDENCE_2026_05_30.md): smoke **PASS**; login **200**; status-check **OK**; **CORE10-BLK-CAPTURE-001** **OPEN** (full snapshot not executed); Runtime Doctor / observability staging **NOT VERIFIED**; production/pilot/real-money/market **NO-GO** |
