...
| **CORE10-BLK-OBS-GAPS-001** | **OPEN** | _SRE + ops_ — After L-38 **PARTIAL**: alert routing **PENDING_EVIDENCE**; uptime/synthetics **PENDING_EVIDENCE**; incident/on-call **PENDING_EVIDENCE**; prod logs API **PENDING_EVIDENCE**; money-path observability **PENDING_EVIDENCE**; rollback/restore drill **PENDING_EVIDENCE**; SRE sign-off **PENDING_EVIDENCE** — see [L-39](./ZORA_WALAT_L39_PRODUCTION_ALERTS_UPTIME_INCIDENT_ROUTING_CAPTURE_GATE_2026_06_02.md) manifest |
| **CORE10-BLK-L39-GATE-001** | **FILED / NOT PROOF** | _Program + engineering_ — [L-39](./ZORA_WALAT_L39_PRODUCTION_ALERTS_UPTIME_INCIDENT_ROUTING_CAPTURE_GATE_2026_06_02.md) capture gate **FILED**; **0** PNGs; does **not** prove alerting, uptime, incident, money-path, rollback, or SRE sign-off |
