...
| **AFGCARD01-DUE-DILIGENCE-001** | **BLOCKED / DUE DILIGENCE FILED ONLY** | _Program + legal + compliance + banking + ops_ — bank, switch/APS/AfPay, biller, telecom/top-up, legal/compliance, settlement, security, privacy, support, and pilot-readiness due diligence requirements documented; no approvals, contracts, runtime implementation, integration, transaction, pilot, or production evidence; [DD matrix](./ZORA_WALAT_AFG_CARD01_BANK_SWITCH_BILLER_TELECOM_DUE_DILIGENCE_MATRIX_2026_05_28.md) |
