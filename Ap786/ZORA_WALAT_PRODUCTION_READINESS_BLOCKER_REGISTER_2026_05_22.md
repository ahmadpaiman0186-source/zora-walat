...
| **CORE10-STAGING-DOCTOR-OBS-001** | **BLOCKED / L-26 SURFACE 404 REGRESSION** | _Engineering + SRE + ops_ — [L-26 token refresh](./ZORA_WALAT_L26_CORE10_TOKEN_REFRESH_AFTER_L25_SURFACE_PASS_EVIDENCE_2026_05_31.md): preflight **FAIL** **404** after L-25 **PASS**; login **not attempted**; token **expired**; L-25-class redeploy required; snapshot **NOT EXECUTED**; **CORE10-BLK-CAPTURE-001** **OPEN**; doctor/obs **NOT VERIFIED**; production/pilot/real-money/market **NO-GO** |
