...
| **CORE10-STAGING-DOCTOR-OBS-001** | **BLOCKED / L-21 SNAPSHOT BLOCKED** | _Engineering + SRE + ops_ — [L-21 snapshot](./ZORA_WALAT_L21_CORE10_FULL_READONLY_STAGING_SNAPSHOT_CAPTURE_EVIDENCE_2026_05_30.md): surface **404** + token **expired** at retry; [L-29](./ZORA_WALAT_L29_SURFACE_DRIFT_CONTROL_SAME_WINDOW_TOKEN_REFRESH_EVIDENCE_2026_05_31.md) valid only in-session; **CORE10-BLK-CAPTURE-001** **OPEN**; doctor/obs **NOT VERIFIED**; production/pilot/real-money/market **NO-GO** |
