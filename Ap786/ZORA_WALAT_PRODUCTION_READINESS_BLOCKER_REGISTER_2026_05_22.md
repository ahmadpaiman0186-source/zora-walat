...
| **CORE10-STAGING-DOCTOR-OBS-001** | **BLOCKED / L-16 SURFACE VERIFY FAIL** | _Engineering + SRE + ops_ — [L-16 evidence](./ZORA_WALAT_L16_CORE10_STAGING_AUTH_LOGIN_ROUTE_SURFACE_VERIFICATION_EVIDENCE_2026_05_30.md): guard PASS; `staging-api-smoke` **FAIL** all probes **404** `nextjs_frontend`; login_route **not** reachable; L-14 login failure **confirmed**; redeploy **not** executed; token **NOT** refreshed; **CORE10-BLK-CAPTURE-001** **OPEN**; doctor/obs **NOT VERIFIED**; production/pilot/real-money/market **NO-GO** |
