...
| **CORE10-STAGING-DOCTOR-OBS-001** | **BLOCKED / L-15 LOGIN ROUTE INVESTIGATION** | _Engineering + SRE + ops_ — L-14 login **FAILED** 404; [L-15 investigation gate](./ZORA_WALAT_L15_CORE10_STAGING_AUTH_LOGIN_ROUTE_SURFACE_INVESTIGATION_GATE_2026_05_30.md) filed (hypothesis matrix + L-16 read-only verify plan); token **NOT** refreshed; **CORE10-BLK-CAPTURE-001** **OPEN**; doctor/obs **NOT VERIFIED**; production/pilot/real-money/market **NO-GO** |
