...
| **CORE10-STAGING-DOCTOR-OBS-001** | **BLOCKED / L-18 API SURFACE FIXED** | _Engineering + SRE + ops_ — [L-18 evidence](./ZORA_WALAT_L18_STAGING_API_SURFACE_CORRECTION_REDEPLOY_EVIDENCE_2026_05_30.md): **1×** redeploy `zora-walat-api-staging`; health **200 JSON**; smoke **PASS**; login_route **400** (reachable); token refresh **NOT EXECUTED**; **CORE10-BLK-CAPTURE-001** **OPEN**; doctor/obs **NOT VERIFIED**; production/pilot/real-money/market **NO-GO** |
