...
| **CORE10-BLK-OBS-GAPS-001** | **OPEN** | _SRE + ops_ — [L-70](./ZORA_WALAT_L70_READONLY_L69_EVIDENCE_RE_ATTEMPT_2026_06_06.md): rows 8/9 **IMPROVED PARTIAL**; **NOT FULLY_PROVEN** |
...
| **CORE10-BLK-OBS-GAPS-001** | **OPEN** | _SRE + ops_ — [L-70](./ZORA_WALAT_L70_READONLY_L69_EVIDENCE_RE_ATTEMPT_2026_06_06.md): sandbox/staging + source grep only; **NOT FULLY_PROVEN** |
...
| **CORE10-BLK-L72-STRIPE-DESTINATION-V4-REDACTION-001** | **FILED / REDACTION PASS / 1/1 v4** | _Operator + program_ — [L-72](./ZORA_WALAT_L72_READONLY_STRIPE_DESTINATION_V4_REDACTION_HARDENING_2026_06_07.md); row 8 **IMPROVED PARTIAL**; **NO-GO** |
