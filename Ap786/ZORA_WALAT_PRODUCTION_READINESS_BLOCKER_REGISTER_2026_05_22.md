...
| **AFGCARD02-PARKED-ACTIVATION-GATE-001** | **PARKED / ACTIVATION REQUIRED** | _Program + legal + compliance + engineering_ — AFG-CARD architecture and DD documented; track **intentionally parked**; no runtime, approvals, contracts, integration, transaction, sandbox execution, pilot, or production evidence; future work requires explicit activation approval + E-01…E-10 evidence; [parking gate](./ZORA_WALAT_AFG_CARD02_PARKING_AND_ACTIVATION_GATE_2026_05_28.md) |
