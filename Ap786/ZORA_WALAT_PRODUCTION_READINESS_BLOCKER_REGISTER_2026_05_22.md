...
| **CORE10-STAGING-DOCTOR-OBS-001** | **BLOCKED / L-22 LOGIN FAILED** | _Engineering + SRE + ops_ — [L-22 token refresh](./ZORA_WALAT_L22_CORE10_TOKEN_REFRESH_AFTER_L21_BLOCKED_TOKEN_EVIDENCE_2026_05_31.md): smoke/health **PASS**; single `login` HTTP **500**; token **expired**; [L-21](./ZORA_WALAT_L21_CORE10_FULL_READONLY_STAGING_SNAPSHOT_CAPTURE_EVIDENCE_2026_05_30.md) snapshot **NOT EXECUTED**; **CORE10-BLK-CAPTURE-001** **OPEN**; doctor/obs **NOT VERIFIED**; production/pilot/real-money/market **NO-GO** |
