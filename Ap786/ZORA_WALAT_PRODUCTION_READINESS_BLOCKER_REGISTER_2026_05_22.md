...
| **CORE10-BLK-OBS-GAPS-001** | **OPEN** | _SRE + ops_ — [L-42](./ZORA_WALAT_L42_PRODUCTION_ALERT_UPTIME_SCREENSHOT_REINTAKE_2026_06_02.md): alert routing + alert channel + frontend/API uptime **BLOCKED** (0/4 PNGs); incident/on-call, prod logs, money-path, rollback drill, SRE sign-off **PENDING_EVIDENCE** |
...
| **CORE10-BLK-L40-PARTIAL-001** | **BLOCKED / L-42 REINTAKE** | _Operator + engineering_ — [L-42](./ZORA_WALAT_L42_PRODUCTION_ALERT_UPTIME_SCREENSHOT_REINTAKE_2026_06_02.md): **0/4** after re-intake; operator must file PNGs per [L-41](./ZORA_WALAT_L41_PRODUCTION_ALERT_UPTIME_OPERATOR_SCREENSHOT_CAPTURE_RETRY_GATE_2026_06_02.md) |
| **CORE10-BLK-L42-REINTAKE-001** | **BLOCKED_MISSING_OPERATOR_SCREENSHOTS** | _Operator + engineering_ — [L-42](./ZORA_WALAT_L42_PRODUCTION_ALERT_UPTIME_SCREENSHOT_REINTAKE_2026_06_02.md): **0** of **4** required PNGs in L-39 intake folder |
| **CORE10-BLK-L41-GATE-001** | **FILED / NOT PROOF** | _Program + engineering_ — [L-41](./ZORA_WALAT_L41_PRODUCTION_ALERT_UPTIME_OPERATOR_SCREENSHOT_CAPTURE_RETRY_GATE_2026_06_02.md) retry capture gate **FILED**; **0** PNGs; does **not** prove observability or change **NO-GO** |
