...
| **CORE10-BLK-SCREENSHOT-001** | **OPEN / PENDING_OPERATOR_CAPTURE** | _Operator + engineering_ — [L-36B](./ZORA_WALAT_L36B_PRODUCTION_DASHBOARD_SCREENSHOT_REINTAKE_EVIDENCE_2026_06_01.md) re-intake: **0** redacted production dashboard PNGs ingested; place files in `Ap786/evidence/l36b-production-dashboard-screenshot-reintake-2026-06-01/screenshots-redacted/`; staging/sandbox PNGs **not** accepted as prod proof |
