...
| **G-02-WH-STG** | **FAILED / INCONCLUSIVE** | _Payments + engineering_ — STR-02 **404**; [Vercel read-only diagnostics](./ZORA_WALAT_STR02_VERCEL_READONLY_ROUTING_DIAGNOSTICS_2026_05_24.md) captures **PENDING**; root cause **NOT CONFIRMED** |
