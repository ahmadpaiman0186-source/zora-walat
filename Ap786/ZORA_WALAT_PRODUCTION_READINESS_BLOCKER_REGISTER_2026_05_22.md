...
| **CORE10-BLK-L76-WIRED-PATH-DRY-RUN-001** | **BLOCKED / DISCOVERY FILED** | _Program_ — [L-76](./ZORA_WALAT_L76_READONLY_WIRED_PATH_SAFETY_INVARIANT_DRY_RUN_ELIGIBILITY_2026_06_07.md); no safe wired-path dry-run; CORE-05/06 **not wired**; **NO-GO** |
