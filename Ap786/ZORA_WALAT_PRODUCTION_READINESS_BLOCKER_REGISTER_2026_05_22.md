...
| **CORE10-BLK-L84B-CREDENTIAL-READINESS-001** | **PARTIAL / OPS TOKEN OPEN** | _Operator + program_ — [L-84C](./ZORA_WALAT_L84C_CREDENTIAL_READINESS_EXECUTION_2026_06_08.md); tier+probe disable set; `OPS_HEALTH_TOKEN` + local `ZW_OPS_HEALTH_TOKEN` **BLOCKED**; **NO-GO** |
