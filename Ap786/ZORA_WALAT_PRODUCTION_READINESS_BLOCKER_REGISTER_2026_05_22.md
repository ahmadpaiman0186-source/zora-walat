...
| **CORE10-BLK-OBS-GAPS-001** | **OPEN** | _SRE + ops_ — [L-44](./ZORA_WALAT_L44_PRODUCTION_OBSERVABILITY_EVIDENCE_RECONCILIATION_2026_06_02.md): alert/uptime **4/4 PNG intake closed**; incident/on-call, prod logs, money-path, rollback drill, SRE sign-off, anomaly detection, real incident handling **PENDING_EVIDENCE** |
