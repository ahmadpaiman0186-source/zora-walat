...
| **CORE10-STAGING-DOCTOR-OBS-001** | **PARTIAL VERIFIED** | _Engineering + SRE + ops_ — [L-30](./ZORA_WALAT_L30_SAME_WINDOW_REDEPLOY_TOKEN_REFRESH_READONLY_SNAPSHOT_EVIDENCE_2026_05_31.md) snapshot **COMPLETED**; [L-31](./ZORA_WALAT_L31_CORE10_STAGING_RUNTIME_DOCTOR_OBSERVABILITY_PROOF_2026_05_31.md) doctor/obs read-only **PARTIAL** (Vercel logs **yes**; token expired at L-31); production observability manifest **NOT PROVEN**; production/pilot/real-money/market **NO-GO** |
