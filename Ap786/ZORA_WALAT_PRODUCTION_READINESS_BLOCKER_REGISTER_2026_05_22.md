...
| **CORE10-BLK-OBS-GAPS-001** | **OPEN** | _SRE + ops_ — [L-46](./ZORA_WALAT_L46_OPERATOR_READONLY_OBSERVABILITY_EVIDENCE_COLLECTION_GATE_2026_06_02.md): production observability remains not fully proven; operator capture **NOT EXECUTED**; L-45 rows 3–12 **PENDING_EVIDENCE** |
...
| **CORE10-BLK-L46-OPERATOR-READONLY-EVIDENCE-001** | **FILED / GATE ONLY / PENDING CAPTURE** | _Operator + SRE_ — [L-46](./ZORA_WALAT_L46_OPERATOR_READONLY_OBSERVABILITY_EVIDENCE_COLLECTION_GATE_2026_06_02.md) defines safe read-only capture protocol; does **not** collect evidence; capture **NOT EXECUTED**; **NO-GO** |
