...
| **CORE10-STAGING-DOCTOR-OBS-001** | **BLOCKED / L-27 SURFACE PASS — TOKEN + SNAPSHOT PENDING** | _Engineering + SRE + ops_ — [L-27 redeploy](./ZORA_WALAT_L27_STAGING_API_SURFACE_CORRECTION_REDEPLOY_AFTER_L26_BLOCKED_PREFLIGHT_EVIDENCE_2026_05_31.md): `dpl_FJQ3LpzHz9QC4vVvqWcGvx2xnAoi` health/smoke **PASS**; operator token **expired**; snapshot **NOT EXECUTED**; **CORE10-BLK-CAPTURE-001** **OPEN**; doctor/obs **NOT VERIFIED**; production/pilot/real-money/market **NO-GO** |
