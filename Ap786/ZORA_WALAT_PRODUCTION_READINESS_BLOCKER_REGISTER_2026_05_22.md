...
| **CORE10-STAGING-DOCTOR-OBS-001** | **BLOCKED / L-14 LOGIN FAILED 404** | _Engineering + SRE + ops_ — [L-14 evidence](./ZORA_WALAT_L14_CORE10_STAGING_OPERATOR_CREDENTIAL_TOKEN_REFRESH_EVIDENCE_2026_05_30.md): creds present; login **FAILED** HTTP 404 `route_missing_or_wrong_deployment` / `nextjs_frontend`; token refresh **NOT COMPLETED**; status-check **SKIPPED**; **CORE10-BLK-CAPTURE-001** **OPEN**; doctor/obs **NOT VERIFIED**; production/pilot/real-money/market **NO-GO** |
