...
| **CORE10-STAGING-DOCTOR-OBS-001** | **BLOCKED / L-28 SURFACE 404 REGRESSION** | _Engineering + SRE + ops_ — [L-28 token refresh](./ZORA_WALAT_L28_CORE10_TOKEN_REFRESH_AFTER_L27_SURFACE_PASS_EVIDENCE_2026_05_31.md): health **404** after L-27 **PASS**; login **not attempted**; token **expired**; redeploy recovery **PENDING**; snapshot **NOT EXECUTED**; **CORE10-BLK-CAPTURE-001** **OPEN**; doctor/obs **NOT VERIFIED**; production/pilot/real-money/market **NO-GO** |
