...
| **CORE10-STAGING-DOCTOR-OBS-001** | **BLOCKED / L-21 BLOCKED_TOKEN** | _Engineering + SRE + ops_ — [L-21 snapshot evidence](./ZORA_WALAT_L21_CORE10_FULL_READONLY_STAGING_SNAPSHOT_CAPTURE_EVIDENCE_2026_05_30.md): smoke + API health **PASS**; gitignored operator token **expired** at preflight; full capture **NOT STARTED**; **CORE10-BLK-CAPTURE-001** **OPEN**; doctor/obs **NOT VERIFIED**; production/pilot/real-money/market **NO-GO** |
