...
| **CORE10-STAGING-DOCTOR-OBS-001** | **STAGING VERIFIED / PROD OBS PARTIAL** | _Engineering + SRE + ops_ — L-30..L-35 track **PARTIAL/PENDING**; production obs **NOT PROVEN**; **NO-GO** |
| **CORE10-BLK-SCREENSHOT-001** | **OPEN / PENDING_OPERATOR_CAPTURE** | _Operator + engineering_ — [L-36B](./ZORA_WALAT_L36B_PRODUCTION_DASHBOARD_SCREENSHOT_REINTAKE_EVIDENCE_2026_06_01.md) re-intake: **0** redacted production dashboard PNGs ingested; [L-37](./ZORA_WALAT_L37_PRODUCTION_OBSERVABILITY_CAPTURE_GATE_2026_06_01.md) capture gate defines required categories; intake: `Ap786/evidence/l37-production-observability-capture-gate-2026-06-01/screenshots-redacted/`; staging/sandbox PNGs **not** accepted |
