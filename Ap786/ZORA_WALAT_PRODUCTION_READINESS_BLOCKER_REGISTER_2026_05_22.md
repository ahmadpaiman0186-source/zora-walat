...
| **CORE10-BLK-OBS-GAPS-001** | **OPEN** | _SRE + ops_ — [L-40](./ZORA_WALAT_L40_PRODUCTION_ALERT_ROUTING_UPTIME_SCREENSHOT_INTAKE_2026_06_02.md): alert routing + alert channel + frontend/API uptime **PENDING_OPERATOR_CAPTURE** (0/4 PNGs); incident/on-call, prod logs, money-path, rollback drill, SRE sign-off **PENDING_EVIDENCE** |
...
| **CORE10-BLK-L40-PARTIAL-001** | **PENDING_OPERATOR_CAPTURE** | _Operator + engineering_ — [L-40](./ZORA_WALAT_L40_PRODUCTION_ALERT_ROUTING_UPTIME_SCREENSHOT_INTAKE_2026_06_02.md): **0** alert/uptime PNGs; [L-41](./ZORA_WALAT_L41_PRODUCTION_ALERT_UPTIME_OPERATOR_SCREENSHOT_CAPTURE_RETRY_GATE_2026_06_02.md) retry gate defines exact capture requirements |
