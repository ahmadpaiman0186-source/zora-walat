...
| **CARD00-DIGITAL-CARD-BANK-PARTNER-001** | **BLOCKED / ARCHITECTURE FILED ONLY** | _Program + legal + compliance + banking_ — digital card, bank partner, ATM/POS/online payment, card-linked transfer, and recipient activation architecture documented; no bank contract, issuer/processor approval, payment network approval, legal/compliance approval, runtime implementation, card issuance, card tokenization, DB schema, migration, wallet/card mutation, ATM/POS transaction, online payment, provider integration, real-money transaction, pilot, or production evidence; CARD0-G1..G8 **BLOCKED**; [architecture](./ZORA_WALAT_CARD00_DIGITAL_CARD_BANK_PARTNER_ARCHITECTURE_2026_05_28.md) |
