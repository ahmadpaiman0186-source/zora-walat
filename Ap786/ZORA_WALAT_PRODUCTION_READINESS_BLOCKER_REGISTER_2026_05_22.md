...
| **CORE10-STAGING-DOCTOR-OBS-001** | **BLOCKED / L-13 CREDENTIAL GAP GATE FILED** | _Engineering + SRE + ops_ — L-10 API **CORRECTED**; L-12 **BLOCKED_CREDS_MISSING** ([L-12](./ZORA_WALAT_L12_CORE10_TOKEN_REFRESH_RETRY_EVIDENCE_2026_05_30.md)); [L-13 credential gap gate](./ZORA_WALAT_L13_CORE10_STAGING_OPERATOR_CREDENTIAL_GAP_RESOLUTION_GATE_2026_05_30.md) — password may be added only under future L-14 phrase; **no** credential setup in L-13; **CORE10-BLK-CAPTURE-001** **OPEN**; doctor/obs **NOT VERIFIED**; production/pilot/real-money/market **NO-GO** |
