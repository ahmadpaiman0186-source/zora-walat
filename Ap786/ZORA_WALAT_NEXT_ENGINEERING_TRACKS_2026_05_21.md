...
| **CORE-10 staging doctor + observability** | [L-6 capture evidence](./ZORA_WALAT_L6_CORE10_READONLY_STAGING_SNAPSHOT_CAPTURE_EVIDENCE_2026_05_30.md) — minimum read-only **EXECUTED** (partial); full proof **NOT VERIFIED** |
