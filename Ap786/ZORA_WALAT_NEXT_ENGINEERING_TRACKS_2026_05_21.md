...
| **CORE-10 staging doctor + observability** | [L-31](./ZORA_WALAT_L31_CORE10_STAGING_RUNTIME_DOCTOR_OBSERVABILITY_PROOF_2026_05_31.md) read-only **PARTIAL**; token refresh + operator log correlation — next gated step; production obs manifest **NOT PROVEN** |
