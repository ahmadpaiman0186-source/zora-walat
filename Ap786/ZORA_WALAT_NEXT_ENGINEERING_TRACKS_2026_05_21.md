...
| **CORE-10 staging doctor + observability** | L-34 **PARTIAL**; L-35/L-36B screenshots **PENDING**; [L-37](./ZORA_WALAT_L37_PRODUCTION_OBSERVABILITY_CAPTURE_GATE_2026_06_01.md) capture gate **FILED**; SRE sign-off — **PENDING** |
...
| **L-37 prod obs capture gate** | [L-37](./ZORA_WALAT_L37_PRODUCTION_OBSERVABILITY_CAPTURE_GATE_2026_06_01.md) **L37_CAPTURE_GATE_FILED_NOT_PROOF** — operator manual capture per gate pack |
