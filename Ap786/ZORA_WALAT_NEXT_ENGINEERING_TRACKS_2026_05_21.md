...
| **L-84ZS post-L84ZR reconciliation** | [L-84ZS](./ZORA_WALAT_L84ZS_POST_L84ZR_MERGE_RECONCILIATION_DEPLOYMENT_BINDING_2026_06_15.md) **MERGED** (#252) |
| **L-84ZT runtime side-effect / audit verification** | [L-84ZT](./ZORA_WALAT_L84ZT_RUNTIME_SIDE_EFFECT_AUDIT_DB_VERIFICATION_READ_ONLY_2026_06_15.md) **MERGED** (#253) — **PARTIAL** (DB not proven) |
| **L-84ZU checkout/auth mutation boundary readiness** | [L-84ZU](./ZORA_WALAT_L84ZU_CHECKOUT_AUTH_MUTATION_BOUNDARY_READINESS_NO_EXECUTION_2026_06_15.md) **MERGED** (#254) |
| **L-84ZV controlled checkout negative POST runtime** | [L-84ZV](./ZORA_WALAT_L84ZV_CONTROLLED_CHECKOUT_NEGATIVE_POST_RUNTIME_PROOF_2026_06_15.md) **MERGED** (#255) — C1–C4 **PARTIAL** (404 HTML routing) |
| **L-84ZW checkout API routing bridge fix** | [L-84ZW](./ZORA_WALAT_L84ZW_CHECKOUT_API_ROUTING_BRIDGE_FIX_LOCAL_PROOF_2026_06_15.md) **MERGED** (#256) |
| **L-84ZX post-L84ZW merge + staging binding** | [L-84ZX](./ZORA_WALAT_L84ZX_POST_L84ZW_MERGE_DEPLOYMENT_BINDING_READ_ONLY_2026_06_15.md) **MERGED** (#257) |
| **L-84ZY controlled checkout negative POST re-probe** | [L-84ZY](./ZORA_WALAT_L84ZY_CONTROLLED_CHECKOUT_NEGATIVE_POST_RUNTIME_REPROBE_2026_06_15.md) **MERGED** (#258) — C1–C4 **PASS** |
| **L-84ZZ post-L84ZY side-effect / audit boundary** | [L-84ZZ](./ZORA_WALAT_L84ZZ_POST_L84ZY_SIDE_EFFECT_AUDIT_DB_BOUNDARY_2026_06_15.md) **MERGED** (#259) — **PARTIAL** (DB zero-write not proven) |
| **L-85A direct SELECT-only DB/audit zero-write (L-84ZY C1–C4 window)** | [L-85A](./ZORA_WALAT_L85A_DIRECT_DB_AUDIT_ZERO_WRITE_VERIFICATION_2026_06_15.md) **MERGED** (#260) — **PARTIAL** (local Neon counts 0; staging DB identity unproven) |
| **L-85B staging DATABASE_URL identity + read-only DB role proof** | [L-85B](./ZORA_WALAT_L85B_STAGING_DATABASE_URL_IDENTITY_AND_READ_ONLY_DB_ROLE_PROOF_2026_06_15.md) **MERGED** (#261) — **PARTIAL** |
| **L-85C operator redacted Vercel staging DATABASE_URL identity attestation** | [L-85C](./ZORA_WALAT_L85C_OPERATOR_REDACTED_VERCEL_STAGING_DATABASE_URL_IDENTITY_ATTESTATION_2026_06_15.md) **MERGED** (#262) — **PARTIAL** |
| **L-85D dedicated read-only DB role proof** | [L-85D](./ZORA_WALAT_L85D_DEDICATED_READ_ONLY_DB_ROLE_PROOF_2026_06_15.md) **MERGED** (#263) — **PARTIAL** (`READ_ONLY_ROLE_NOT_PROVEN`) |
| **L-85E read-only DB role provisioning readiness** | [L-85E](./ZORA_WALAT_L85E_READ_ONLY_DB_ROLE_PROVISIONING_READINESS_OPERATOR_APPROVAL_GATE_2026_06_16.md) **MERGED** (#264) — **FILED** |
| **L-85F operator-controlled read-only DB role provisioning** | [L-85F](./ZORA_WALAT_L85F_OPERATOR_CONTROLLED_READ_ONLY_DB_ROLE_PROVISIONING_2026_06_16.md) **PREPARED** — `zora_walat_readonly_audit` provisioned (L-85G pending) |
