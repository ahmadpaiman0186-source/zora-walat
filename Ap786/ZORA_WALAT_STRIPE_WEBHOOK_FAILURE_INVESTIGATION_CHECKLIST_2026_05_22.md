...
| SD-02 | Failed deliveries list incl. `checkout.session.expired` (May 19 2026 2:10:08 PM) | Test | **EVIDENCE FILED (redacted)** — [LIST-001.png](./evidence/stripe-webhook-failure-2026-05-22/STRIPE-WH-DASHBOARD-EVENT-DELIVERIES-CHECKOUT-EXPIRED-FAILED-LIST-001.png) |
| SD-03 | Failed delivery detail + error insight (timeout) | Test | **EVIDENCE FILED (redacted)** — [TIMEOUT-001.png](./evidence/stripe-webhook-failure-2026-05-22/STRIPE-WH-DELIVERY-FAILED-CHECKOUT-SESSION-EXPIRED-TIMEOUT-001.png) · [ERROR-INSIGHT-001.png](./evidence/stripe-webhook-failure-2026-05-22/STRIPE-WH-DELIVERY-FAILED-CHECKOUT-SESSION-EXPIRED-ERROR-INSIGHT-001.png) |
...
| VC-01b | Vercel Observability Plus / 30-day retention limitation | **EVIDENCE FILED (redacted)** — [RETENTION-001.png](./evidence/stripe-webhook-failure-2026-05-22/VERCEL-STAGING-LOGS-RETENTION-LIMITATION-001.png) |
| VC-01c | Vercel historical correlation (May 19 window) | **BLOCKED / INCONCLUSIVE** — retention on Hobby tier |
