...
| CORE-10 staging doctor + observability gate | **L-6** partial capture (PR #121); **L-7** token/API gate ([L-7](./ZORA_WALAT_L7_CORE10_TOKEN_REFRESH_API_BASE_APPROVAL_GATE_2026_05_30.md)); L-8 **PENDING**; proof **NOT VERIFIED**; **NO-GO** |
