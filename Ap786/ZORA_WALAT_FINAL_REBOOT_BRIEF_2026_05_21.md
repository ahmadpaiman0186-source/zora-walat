...
| CORE-10 staging doctor + observability gate | **L-10** API fixed; **L-12** token retry **BLOCKED** ([L-12](./ZORA_WALAT_L12_CORE10_TOKEN_REFRESH_RETRY_EVIDENCE_2026_05_30.md) — password missing); snapshot/doctor/obs **NOT VERIFIED**; **NO-GO** |
