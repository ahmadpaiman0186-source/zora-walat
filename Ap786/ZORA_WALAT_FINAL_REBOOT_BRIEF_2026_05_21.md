...
| CORE-10 staging doctor + observability gate | **L-10** API redeploy **EXECUTED** ([L-10](./ZORA_WALAT_L10_STAGING_API_SURFACE_CORRECTION_REDEPLOY_EVIDENCE_2026_05_30.md)); health/smoke **PASS**; snapshot/doctor/obs proof **NOT VERIFIED**; **NO-GO** launch |
