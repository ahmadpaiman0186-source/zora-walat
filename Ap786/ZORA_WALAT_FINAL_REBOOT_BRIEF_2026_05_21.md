...
| CORE-10 staging doctor + observability gate | **L-25** API surface redeploy **PASS** ([L-25](./ZORA_WALAT_L25_STAGING_API_SURFACE_CORRECTION_REDEPLOY_EVIDENCE_2026_05_31.md)); L-22 login **500** inconclusive; token/snapshot **NOT EXECUTED**; doctor/obs **NOT VERIFIED**; **NO-GO** |
