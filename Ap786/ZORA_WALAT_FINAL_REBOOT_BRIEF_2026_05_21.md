...
| CORE-10 staging doctor + observability gate | **L-9** redeploy gate ([L-9](./ZORA_WALAT_L9_CORE10_STAGING_API_SURFACE_CORRECTION_REDEPLOY_APPROVAL_GATE_2026_05_30.md)); L-8 smoke **FAIL** (frontend on API host); L-10 redeploy **PENDING**; proof **NOT VERIFIED**; **NO-GO** |
