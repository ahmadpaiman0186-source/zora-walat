...
| CORE-10 staging doctor + observability gate | **L-21** snapshot **BLOCKED** ([L-21](./ZORA_WALAT_L21_CORE10_FULL_READONLY_STAGING_SNAPSHOT_CAPTURE_EVIDENCE_2026_05_30.md)); L-29 token valid only in-session; **CORE10-BLK-CAPTURE-001** **OPEN**; **NO-GO** |
