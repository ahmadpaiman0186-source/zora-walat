...
| CORE-10 staging doctor + observability gate | **FILED** — PR #116–#117; **L-3** (PR #118); **L-4 auth gate** ([L-4](./ZORA_WALAT_L4_CORE10_READONLY_CAPTURE_AUTHORIZATION_DECISION_GATE_2026_05_30.md)); capture **NOT EXECUTED**; staging/obs **NOT VERIFIED**; **NO-GO** |
