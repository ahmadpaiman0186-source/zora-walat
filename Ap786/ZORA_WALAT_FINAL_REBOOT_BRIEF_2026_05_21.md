...
| CORE-10 staging doctor + observability gate | **L-30** snapshot **COMPLETED**; **L-31** doctor/obs **PARTIAL**; **L-32** status+log correlation **SUCCESS** ([L-32](./ZORA_WALAT_L32_SAME_WINDOW_TOKEN_REFRESH_OPERATOR_STATUS_LOG_CORRELATION_2026_05_31.md)); production obs manifest **NOT PROVEN**; **NO-GO** |
