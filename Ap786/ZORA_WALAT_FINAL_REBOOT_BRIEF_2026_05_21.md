...
| CORE-10 staging doctor + observability gate | **L-8** verify ([L-8](./ZORA_WALAT_L8_CORE10_TOKEN_REFRESH_API_BASE_VERIFY_EVIDENCE_2026_05_30.md)) — token refresh **FAIL**; API smoke **FAIL**; snapshot **NOT** captured; proof **NOT VERIFIED**; **NO-GO** |
