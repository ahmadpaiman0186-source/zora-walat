...
**Date:** 2026-05-25
**Status:** **PROBE EXECUTED / OPERATOR LOG CAPTURE PENDING**
...
| STR08-004 | `ZW_STRIPE_WEBHOOK_OBSERVABILITY` log search | Marker visible or no-result captured | **PENDING OPERATOR CAPTURE** |
| STR08-005 | `route_entry` log search | Marker visible or no-result captured | **PENDING OPERATOR CAPTURE** |
| STR08-006 | `signature_verification_failed` log search | Marker visible or no-result captured | **PENDING OPERATOR CAPTURE** |
| STR08-007 | `response_sent` log search | Marker visible or no-result captured | **PENDING OPERATOR CAPTURE** |
...
| Operator screenshots absent | Leave rows as pending capture |

---

*Capture matrix - no screenshots fabricated; Vercel marker captures pending*
